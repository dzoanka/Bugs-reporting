...
urlpatterns = [
    ...
    path('bugs/<str:project>/', views.displayBugsForProject, name='bugs'),
    ...
    path('bug/<str:uuid>/<str:project>/update/', views.ProjectBugUpdate.as_view(), name='bug-update-project'),
